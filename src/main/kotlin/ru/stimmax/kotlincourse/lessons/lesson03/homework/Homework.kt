...
// 3. Место проведения известно на момент написания
val location: String by lazy {
    "Maestro Hall, Boston, USA"
}
...
const val EVENT_DURATION: Int = 3
...
var evacuationPlan: String? = null
    private set(value) {
        field = value
    }
...
val policy: String by lazy {
    "[ какой то текст о политика конфиденциальности, никто его не читает, кроме юристов ]"
}
